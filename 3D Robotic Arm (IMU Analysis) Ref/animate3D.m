...
% SUMMARY
    ...
    axis equal
    h1 = plot3(xB(1),yB(1),zB(1),'ro','MarkerFaceColor','r',"LineWidth",3);
    hold on;
    h2 = line([xB(1) x1(1)],[yB(1) y1(1)],[zB(1) z1(1)],'color','b','LineWidth',3);
    h3 = plot3(x1(1),y1(1),z1(1),'go','MarkerFaceColor','g','LineWidth',3);
    h4 = line([x1(1) x2(1)],[y1(1) y2(1)],[z1(1) z2(1)],'color','k','LineWidth',3);
    h5 = plot3(x2(1),y2(1),z2(1),'^','Color',"#FF0000",'MarkerFaceColor',"#FF0000",'LineWidth',3,"MarkerSize",10);
    axis([-platform.l1-platform.l2-0.02-3 platform.l1+platform.l2+0.02+3 -platform.l1-platform.l2-0.02 platform.l1+platform.l2+0.02 -platform.l1-platform.l2-0.02-0.5 platform.l1+platform.l2+0.02+0.5]);
